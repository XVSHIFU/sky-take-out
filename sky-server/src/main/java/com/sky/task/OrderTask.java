...
public class OrderTask {
    ...
    public void processTimeoutOrder() {
        ...
        List<Orders> odList = orderMapper.getByStatusAndOrderTimeLT(Orders.PENDING_PAYMENT, time);
    ...
    public void processDeliveryOrder() {
        ...
        List<Orders> odList = orderMapper.getByStatusAndOrderTimeLT(Orders.DELIVERY_IN_PROGRESS, time);
        if (odList != null && odList.size() > 0) {
            odList.forEach(od -> {
